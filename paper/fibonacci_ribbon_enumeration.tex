...
of Ballot-Admissible Fibonacci Ribbons}
\author{Alex Chengyu Li}
\date{29 August 2026}
\hypersetup{
  pdftitle={Exact Enumeration and Fixed-Rank Asymptotics of Ballot-Admissible Fibonacci Ribbons},
...
tableaux beyond the three-letter case.  We give an exact formula for every
alphabet size.  If $b_{n,k}$ denotes the number of ballot-admissible
...
$k$ of degree $r-1$ with an explicit leading coefficient.
\end{abstract}
